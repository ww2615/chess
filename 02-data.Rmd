...
Not all games from the database is guaranteed to have [%clk] or [%eval] which are the clock time and evaluation of the position. According to the lichess database, around 6% of the games are annotated with evaluation.
