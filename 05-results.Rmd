...
Players have to make decisions in a short period of time and the quality of decision is related to time. Using **Time ratio** is one of the ways to study the relationship

#### Quality of moves when remaining time is low

#### Quality of moves when time spent is low
...
2. Considering **time forfeit** games only, **time ratio** of the winner are mostly below 10% while the density plot shows it concentrated at **Time ratio** = 2 and **Move Number** = 30.
