...
#ggplot(data = game1, aes(x = Timet, color = fct_relevel(Type, "normal", "dubious", "mistake", "blunder"))) + 
#   geom_density(size = 1) +
#   xlab("Time Left") +
#   labs(color = "legend")+
#  geom_vline(xintercept = 300)+
#  ggtitle("From 6 mins to 4 mins left")
#ggplot(data = game2, aes(x = Timet, color = fct_relevel(Type, "normal", "dubious", "mistake", "blunder"))) + 
#   geom_density(size = 1) +
#  xlab("Time Left") +
#  labs(color = "legend")+
