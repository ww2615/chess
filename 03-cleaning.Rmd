...
The [timecount.csv] (https://github.com/ww2615/chessgame_analysis/blob/main/data/timecount.csv) was generated through [count.py](https://github.com/ww2615/chessgame_analysis/blob/main/code/count.py).
...
## Is 600+0 a good representative sample?
...
The [elocount.csv] (https://github.com/ww2615/chessgame_analysis/blob/main/data/elocount.csv) and [elo600count.csv] (https://github.com/ww2615/chessgame_analysis/blob/main/data/elo600count.csv)  was generated through [count.py](https://github.com/ww2615/chessgame_analysis/blob/main/code/count.py).
```{r}
defaultW <- getOption("warn") 
options(warn = -1)
